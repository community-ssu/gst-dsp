...
#define XDM_APPLIEDCONCEALMENT 9
#define XDM_UNSUPPORTEDINPUT 13
#define XDM_UNSUPPORTEDPARAM 14
#define XDM_FATALERROR 15

#define XDM_ERROR_IS_UNSUPPORTED(x) ((x) & (1 << XDM_UNSUPPORTEDINPUT | 1 << XDM_UNSUPPORTEDPARAM))
#define XDM_ERROR_IS_APPLIEDCONCEALMENT(x) ((x) & (1 << XDM_APPLIEDCONCEALMENT))
#define XDM_ERROR_IS_FATAL(x) ((x) & (1 << XDM_FATALERROR))
...
struct _GstDspBase {
	...
	GstFlowReturn (*send_buffer)(GstDspBase *self, struct td_buffer *tb);
...
extern struct td_codec td_hdh264dec_bp_codec;
extern struct td_codec td_hdh264dec_hp_codec;
extern struct td_codec td_hdh264enc_codec;

extern struct td_codec td_mp4venc_codec;
extern struct td_codec td_jpegenc_codec;
extern struct td_codec td_h264enc_codec;
extern struct td_codec td_hdmp4venc_codec;
